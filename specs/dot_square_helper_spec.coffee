describe "Dot to square conversion helpers", ->
  ...
  it "should identify and locate the squares that intersect the 'hex zone' for dot a,b", ->
    ...
    # sqq = @helper.find_squares()
    # expect(sqq.xxyy).toEqual( [] )
    # expect(sqq.dxy).toEqual( [] )
    # expect(sqq.squares[0]).toEqual( [] )
    # expect(sqq.squares[1]).toEqual( [] )
    # expect(sqq.squares[2]).toEqual( [] )
    # expect(sqq.squares[3]).toEqual( [] )
    #
    # sqq = @helper.find_squares()
    # expect(sqq.xxyy).toEqual( [] )
    # expect(sqq.dxy).toEqual( [] )
