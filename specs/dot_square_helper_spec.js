...
describe("Dot to square conversion helpers", function() {
  beforeEach(function() {
    return this.helper = new DotSquareHelper;
  });
  it("should find the 12x12 square containing point x,y", function() {
    var xy12;
    xy12 = this.helper.get_xxyy(0, 0);
    expect(xy12.xxyy).toEqual([0, 0]);
    expect(xy12.dxy).toEqual([0, 0]);
    xy12 = this.helper.get_xxyy(19, 8);
    expect(xy12.xxyy).toEqual([1, 0]);
    expect(xy12.dxy).toEqual([7, 8]);
    xy12 = this.helper.get_xxyy(433, 293);
    expect(xy12.xxyy).toEqual([36, 24]);
    expect(xy12.dxy).toEqual([1, 5]);
    xy12 = this.helper.get_xxyy(279, 527);
    expect(xy12.xxyy).toEqual([23, 43]);
    expect(xy12.dxy).toEqual([3, 11]);
    xy12 = this.helper.get_xxyy(382, 177);
    expect(xy12.xxyy).toEqual([31, 14]);
    expect(xy12.dxy).toEqual([10, 9]);
    xy12 = this.helper.get_xxyy(351, 444);
    expect(xy12.xxyy).toEqual([29, 37]);
    return expect(xy12.dxy).toEqual([3, 0]);
  });
  return it("should identify and locate the squares that intersect the 'hex zone' for dot a,b", function() {
    var sqq;
    sqq = this.helper.find_squares(1, 16);
    ...
    sqq = this.helper.find_squares(3, 16);
    ...
    sqq = this.helper.find_squares(2, 17);
    ...
    sqq = this.helper.find_squares(4, 17);
    expect(sqq.xxyy).toEqual([0, 0]);
    ...
    expect(sqq.squares[2]).toEqual([0, 1]);
    expect(sqq.squares[3]).toEqual([1, 1]);
    sqq = this.helper.find_squares(19, 40);
    ...
    sqq = this.helper.find_squares(99, 44);
    ...
    sqq = this.helper.find_squares(0, 15);
    expect(sqq.xxyy).toEqual([-1, -1]);
    ...
    expect(sqq.squares[2]).toEqual(null);
    expect(sqq.squares[3]).toEqual([0, 0]);
    sqq = this.helper.find_squares(0, 17);
    ...
    sqq = this.helper.find_squares(4, 15);
    expect(sqq.xxyy).toEqual([0, -1]);
    ...
    expect(sqq.squares[2]).toEqual([0, 0]);
    expect(sqq.squares[3]).toEqual([1, 0]);
    sqq = this.helper.find_squares(112, 5);
    expect(sqq.xxyy).toEqual([32, -1]);
    expect(sqq.dxy).toEqual([4, 7]);
    expect(sqq.squares[0]).toEqual(null);
    expect(sqq.squares[1]).toEqual(null);
    expect(sqq.squares[2]).toEqual([32, 0]);
    return expect(sqq.squares[3]).toEqual([33, 0]);
  });
});
